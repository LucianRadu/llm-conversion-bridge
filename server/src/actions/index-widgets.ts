...
import { widgetMeta as bitdefenderRenderProductsMeta } from './bitdefenderRenderProducts/widget';
...
const bitdefenderRenderProductsResource: MCPResource = {
  ...bitdefenderRenderProductsMeta,
  content: `<script src="https://demo-bitdefender--chatgpt-eds--lucianradu.aem.live/scripts/aem-embed.js" type="module"></script>
<div>
    <aem-embed url="https://demo-bitdefender--chatgpt-eds--lucianradu.aem.live/widgets/demo-bitdefender"></aem-embed>
</div>
`
};
...
const widgetResources: MCPResource[] = widgetActions
  .map(action => {
    ...
    if (action.name === 'Bitdefender.renderProducts') {
      return bitdefenderRenderProductsResource;
    }
