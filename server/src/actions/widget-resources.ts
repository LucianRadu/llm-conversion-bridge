 ...
 * This file is separate from index-widgets.ts to avoid circular dependencies
 */
...
// All widget resources
const widgetResourcesArray: MCPResource[] = [
  heartbeatWidgetResource,
  helloWorldEDSResource,
  systemStatusWidgetResource
];

// Create lookup map for efficient access
export const widgetResourcesByUri = new Map<string, MCPResource>();
widgetResourcesArray.forEach((resource) => {
  widgetResourcesByUri.set(resource.uri, resource);
});

export { widgetResourcesArray };
