...
// Use PUBLISH_BASE_URL directly from fastly.toml (set at runtime)
// No parsing needed - fastly.toml has the correct value
export const PUBLISH_BASE_URL = env("PUBLISH_BASE_URL") || '';
