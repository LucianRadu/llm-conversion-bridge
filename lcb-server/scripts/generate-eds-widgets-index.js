...
// Simply return each resource directly - no conditional mapping needed
...
console.log(`\n[${appName}] Successfully generated server/src/actions/index-widgets.ts with ${resourceFiles.length} EDS Widgets:`);
resourceFiles.forEach(file => {
  console.log(`- ${file.relativePath} -> ${file.actionName} (eds-widget)`);
});
