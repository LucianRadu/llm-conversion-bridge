...
function generateActionFile(actionName, hasWidget) {
  ...
  const widgetMeta = hasWidget ? `
    _meta: {
      "openai/outputTemplate": "ui://aem-widget/${toKebabCase(actionName)}-widget.html",
...
export const widgetMeta = {
    uri: "ui://aem-widget/${kebabName}-widget.html",
...
function generateWidgetTemplate(actionName) {
  return `<script src="https://main--chatgpt-eds--lucianradu.aem.live/scripts/aem-embed.js" type="module"></script>
<div>
    <aem-embed url="https://main--chatgpt-eds--lucianradu.aem.live/widgets/${toKebabCase(actionName)}"></aem-embed>
</div>
`;
}
